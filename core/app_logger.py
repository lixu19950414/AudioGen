...
EVENT_BATCH = "batch"
EVENT_MODEL_LOAD = "model_load"
EVENT_MODEL_UNLOAD = "model_unload"

ALL_EVENT_TYPES = [EVENT_LOGIN, EVENT_SYNTHESIZE, EVENT_DOWNLOAD, EVENT_BATCH, EVENT_CHAR_ADD, EVENT_CHAR_REMOVE, EVENT_MODEL_LOAD, EVENT_MODEL_UNLOAD]
